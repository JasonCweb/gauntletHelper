    ...
    var createDivs = function() {
        if (!divsCreated && $(parentDiv).length) {
            ...
            generalDiv = $('<div />').css(style).css({
                ...
                'margin-left': (-generalDivWidth / 2 - 330)
            ...
            cardDivs[2] = $('<div />').css(style).css(cardStyle).css({ 'margin-left': (-width / 2) - (width + separation) - 330 })
                .appendTo($(parentDiv).css('position', 'relative'));

            cardDivs[1] = $('<div />').css(style).css(cardStyle).css({ 'margin-left': (-width / 2) - 330 })
                .appendTo($(parentDiv).css('position', 'relative'));

            cardDivs[0] = $('<div />').css(style).css(cardStyle).css({ 'margin-left': (-width / 2) + (width + separation) - 330 })
                .appendTo($(parentDiv).css('position', 'relative'));
